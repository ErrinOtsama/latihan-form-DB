			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
		                ...
		                <td>
		                	<a href="edit_data.php?id=<?php echo $row['id']; ?>"><i class="far fa-edit" style="color: green"></i></a> |
		                	<a href="delete_data.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Yakin Mau Melupakan Masa Lalu ? ')"><i class="far fa-trash-alt " style="color: red"></i></a>
		                </td>
					</tr>
					<?php
				    }?>
